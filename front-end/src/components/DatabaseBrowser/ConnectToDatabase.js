...
import InvalidDataLabel from "../WelcomePages/InvalidDataLabel";
import BackGroundStyle from "../WelcomePages/BackGroundStyle";
        ...
        <div>
            ...
            <div style={BackGroundStyle}
                ...
                <div className='bg-white p-3 rounded w-50'>
                    {/*<form>*/}
                    <div className='mb-3'>
                        <label htmlFor="username"><strong>Database URL.</strong></label>
                        <input className='form-control rounded-0' type="text" placeholder="Enter Database URL" value={DbURL} onChange={(e) => setDbURL(e.target.value)}/>
                    </div>
                    <div className='mb-3'>
